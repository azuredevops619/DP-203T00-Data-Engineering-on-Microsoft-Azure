...
6. For **Role**, select **`Storage Blob Data Reader`**. Click **Next** -> Click on **+ Select Member** Search for **`tailwind-readers`** and select `tailwind-readers-<suffix>` from the results, then select **Review + Assign** till it saves.
